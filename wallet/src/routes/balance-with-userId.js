...
exports.checkUserWalletBalanceRouter = void 0;
...
exports.checkUserWalletBalanceRouter = router;
router.get("/api/wallet/user/:userId/balance", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
