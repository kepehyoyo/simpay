...
class WalletService {
    static createWallet(walletId, balance, currency) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const newWallet = wallet_1.Wallet.build({ walletId, balance, currency });
    ...
    static creditWalletBalance(walletId, amount) {
        return __awaiter(this, void 0, void 0, function* () {
            const wallet = yield WalletService.getWallet(walletId);
    ...
    static debitWalletBalance(walletId, amount) {
        return __awaiter(this, void 0, void 0, function* () {
            const wallet = yield WalletService.getWallet(walletId);
            wallet.balance -= amount;
            wallet.save();
    ...
    static getTransactionsByWalletId(walletId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
