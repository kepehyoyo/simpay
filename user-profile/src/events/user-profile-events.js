...
exports.CreateUserProfileEvent = void 0;
const subjects_1 = require("./subjects");
//import { Transaction } from "../models/transaction";
class CreateUserProfileEvent {
    constructor(data) {
        this.subject = subjects_1.Subjects.USER_PROFILE_CREATED;
        this.data = data;
    }
}
exports.CreateUserProfileEvent = CreateUserProfileEvent;
