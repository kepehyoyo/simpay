...
// Define the 'GET /api/coupons/list' endpoint
router.get('/api/coupons/list', listCoupons);

 
// Handle the 'GET /api/coupons/list' request
async function listCoupons(req: Request, res: Response) {
  try {
    // Here, you would implement the logic to fetch and list the coupons from your database or coupon service
...
export  {router as listCouponsRouter};
